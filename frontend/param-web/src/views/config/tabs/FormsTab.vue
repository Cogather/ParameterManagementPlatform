<template>
  <dict-crud-table
    ...
    :template-url="resolveParamApiUrl(`/products/${encodeURIComponent(productId)}/effective-forms/import-templates`)"
    :export-url="resolveParamApiUrl(`/products/${encodeURIComponent(productId)}/effective-forms/exports?page=1&size=5000`)"
